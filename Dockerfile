...
#
# 1. Build the image with: docker build --no-cache -t test/beverage-buddy-jooq:latest .
# 2. Run the image with: docker run --rm -ti -p8080:8080 test/beverage-buddy-jooq
#
